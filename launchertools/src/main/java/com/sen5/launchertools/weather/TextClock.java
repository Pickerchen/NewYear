 ...
 * so, use a {@link android.text.Spanned} object.
 * </p>
 * 
...
public class TextClock extends TextView {
    ...
    public void setTimeChangeListener(TimeChangeListener l) {
        mTimeChangeListener = l;
    }

    /**
     * The default formatting pattern in 12-hour mode. This pattenr is used if
     * {@link #setFormat12Hour(CharSequence)} is called with a null pattern or
     * if no pattern was specified when creating an instance of this class.
     * 
    ...
    /**
     * The default formatting pattern in 24-hour mode. This pattenr is used if
     * {@link #setFormat24Hour(CharSequence)} is called with a null pattern or
     * if no pattern was specified when creating an instance of this class.
     * 
    ...
    private void init() {
        ...
        TypefaceUtils.ROBOTO_LIGHT.setTypeface(this);
     ...
     * set to null, {@link #DEFAULT_FORMAT_24_HOUR} and
     ...
     * even in 24-hour mode. If both 24-hour and 12-hour formatting patterns are
     * set to null, {@link #DEFAULT_FORMAT_24_HOUR} and
     * {@link #DEFAULT_FORMAT_12_HOUR} will be used instead.
     * 
     * @param format
     ...
     * formats are null, the default values {@link #DEFAULT_FORMAT_12_HOUR} and
     * {@link #DEFAULT_FORMAT_24_HOUR} are used instead.
     * 
    ...
    private void onTimeChanged() {
        ...
        setText(DateFormat.format(mFormat, mTime).toString().toUpperCase());
        if (null != mTimeChangeListener) {
            mTimeChangeListener.onTimeChanged(!getText().toString().contains("m"));
        }
    }

    public interface TimeChangeListener {
        void onTimeChanged(boolean is24Formate);
    }
