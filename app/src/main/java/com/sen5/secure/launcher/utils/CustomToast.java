...
public class CustomToast implements Callback {
    ...
    public CustomToast(Context context, String strToast) {
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (TOAST == msg.what) {
            ...
            Sen5TextView tvContent = (Sen5TextView) layout.findViewById(R.id.tv_toast_content);
            // int nViewWidth =
            // mContext.getResources().getDisplayMetrics().widthPixels / 4;
            // int nViewHeight =
            // mContext.getResources().getDisplayMetrics().heightPixels;
            // LinearLayout.LayoutParams params = new
            // LinearLayout.LayoutParams(nViewWidth, nViewHeight);
    ...
    /**
     * 采用反射统一 Toast 动画和高宽 使 Toast 动画不再因不同系统而产生差异
     */
