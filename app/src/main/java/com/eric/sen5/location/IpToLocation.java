 ...
 */
package com.eric.sen5.location;
...
public class IpToLocation {
    ...
    public void getLocation() {
        if (mIsLoading) {
            AppLog.w(TAG+ "MultiCall getLocation()");
            return;
        }
            ...
            public void onPost(String netString) {
                ...
                if (!TextUtils.isEmpty(netString)) {
                    ...
                    if (null != mCallBack) {
                        ...
                        Bean bean = JSON.parseObject(netString, Bean.class);
    ...
    public static class Bean {
         ...
         * region : 44 regionName : Guangdong UIStatus : success timezone :
         * Asia/Shanghai zip :
         */
        ...
        public String toString() {
            return "Bean{" + "as='" + as + '\'' + ", city='" + city + '\'' + ", country='" + country + '\''
                    ...
                    + ", regionName='" + regionName + '\'' + ", UIStatus='" + status + '\'' + ", timezone='" + timezone
                    + '\'' + ", zip='" + zip + '\'' + '}';
        }
    }
}
