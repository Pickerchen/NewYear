...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int DEFAULT_MAX_HEIGHT = 190;

    /**
     * The default min width of this widget.
     */
    private static final int DEFAULT_MIN_WIDTH = 36;
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (gainFocus){
            Log.e("onFocusVhanged","获取焦点");
            setSelectedTextColor(0XFF0486ff);
            ViewCompat.animate(this).scaleX(1.17f).scaleY(1.17f).translationZ(1.17f).start();
        }
        else {
            ViewCompat.animate(this).scaleX(1f).scaleY(1f).translationZ(1).start();
            setSelectedTextColor(0Xffffffff);
            Log.e("onFocusChanged","失去了焦点");
        }
    }
...
//        }
    ...
    public interface ChooseCallback{
        void chooseCallback(int value1, int value2, int type);
    }
