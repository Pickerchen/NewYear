...
//        final int childTop = child.getTop() + rect.top - child.getScrollY();
        ...
        if (cannotScrollForwardOrBackward(isVertical() ? dy : dx)) {
            ...
            if (dx != 0 || dy != 0) {
                if (immediate) {
                    Log.e("recyclerViewTV true","dy is "+dy);
                    scrollBy(dx+0, dy+30);
                } else {
                    if (dy > 0){
                        dy += 30;
                    ...
                    Log.e("recyclerViewTV false","dy is "+dy);
...
//    }
    ...
    private boolean mIsShieldKeyDown;
    private boolean mIsShieldKeyUp;
    private boolean mIsShieldKeyRight;
    private boolean mIsShieldKeyLeft;

    public void setShieldKeyDown(boolean isShieldKeyDown){
        mIsShieldKeyDown = isShieldKeyDown;
    }
    public void setShieldKeyUp(boolean isShieldKeyUp){
        mIsShieldKeyUp = isShieldKeyUp;
    }
    public void setShieldKeyRight(boolean isShieldKeyRight){
        mIsShieldKeyRight = isShieldKeyRight;
    }
    public void setShieldKeyLeft(boolean isShieldKeyLeft){
        mIsShieldKeyLeft = isShieldKeyLeft;
    }
...
//            Log.e("AA", "------------------------dispatchKeyEvent123");
            ...
            if (isHorizontalLayoutManger() && keyCode == KeyEvent.KEYCODE_DPAD_UP) {
                if(mIsShieldKeyUp){
                    return true;
                }
            }

            if (isHorizontalLayoutManger() && keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
                if(mIsShieldKeyRight){
                    return true;
                }
            }

            if (isHorizontalLayoutManger() && keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
                if(mIsShieldKeyLeft){
                    return true;
                }
            }
