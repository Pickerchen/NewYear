...
/**
 * Created by chenqianghua on 2016/8/5.
 */
public class WaterWaveView extends View {
    ...
    private void init() {
        setWaveInfo(90f, 6f, 1f, 1f, Color.parseColor("#b5b5b5"));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Wave w : mWaves) {
            ...
            AppLog.i("Wave"+ "wave个数:" + mWaves.size() + "wave:" + w.toString());
        }
        if (mFillWaveSourceShapeRadius > 0f) {
            ...
            AppLog.i("Wave"+"mFillWaveSourceShapeRadius:" + mFillWaveSourceShapeRadius);
